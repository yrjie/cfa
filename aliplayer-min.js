...
!function o(a, s, l) {
    ...
    1: [function(e, t, i) {
        ...
        r = this,
        n = function() {
            var u, i, e, t, r, d, n, o, a, s, l, c, p = p || (u = Math,
                ...
                _doProcessBlock: function(e, t) {
                    for (var i = this._hash.words, r = i[0], n = i[1], o = i[2], a = i[3], s = i[4], l = 0; l < 80; l++) {
                        if (l < 16)
                            ...
                            var c = d[l - 3] ^ d[l - 8] ^ d[l - 14] ^ d[l - 16];
                            d[l] = c << 1 | c >>> 31
                        }
                        var u = (r << 5 | r >>> 27) + s + d[l];
        ...
        !function() {
            ...
            function s(n, e) {
                ...
                !s.notNeeded(n)) {
                    ...
                    l && (n.addEventListener("mouseover", this.onMouse, !0),
                    ...
                    "function" == typeof n.onclick && (t = n.onclick,
            ...
            s.prototype.onTouchEnd = function(e) {
                ...
                "label" === (r = a.tagName.toLowerCase())) {
                    ...
                    return 100 < e.timeStamp - i || c && window.top !== window && "input" === r ? this.targetElement = null : (this.focus(a),
                    this.sendClick(a, e),
                    c && "select" === r || (this.targetElement = null,
                    e.preventDefault())),
                    !1;
                return !(!c || u || !(n = a.fastClickScrollParent) || n.fastClickLastScrollTop === n.scrollTop) || (this.needsClick(a) || (e.preventDefault(),
                this.sendClick(a, e)),
                !1)
            }
            ,
        ...
        e("../lib/util"))
          ...
          , p = r.extend({
            ...
            bindEvent: function() {
                ...
                u.isLiveShift(this._player._options) && this._player.on(d.Player.Play, function() {
            ...
            _onMouseOut: function(e) {
                s.css(this.cursorNode, "display", "none"),
            ...
            _updateCursorPosition: function(e) {
                if (1 != this._player._switchSourcing && (0 != e || 0 != this._player.tag.readyState)) {
                    ...
                    0 != n && (r = 1 - 18 / n),
                    this.cursorNode && (r < t ? (s.css(this.cursorNode, "right", "0px"),
    ...
    19: [function(e, t, i) {
        ...
        if (window.Uint8Array)
            for (var d = new Uint8Array(256), r = 0; r < o.length; r++)
                d[o.charCodeAt(r)] = r;
        var c = function(e) {
        ...
        unpackPlayReady = function(e) {
            var t = function(e, t, i) {
                ...
                for (var o = Math.floor(e.byteLength / 2), a = new Uint16Array(o), s = new DataView(r), l = 0; l < o; l++)
        ...
        t.exports = {
            decode: function(e) {
                ...
                for (t = 0; t < s; t += 4)
                    ...
                    n = d[e.charCodeAt(t + 2)],
                    o = d[e.charCodeAt(t + 3)],
                    u[l++] = i << 2 | r >> 4,
                    u[l++] = (15 & r) << 4 | n >> 2,
                    u[l++] = (3 & n) << 6 | 63 & o;
                return c
            ...
            if (e)
                try {
                    var i = window.getComputedStyle(e)
                      , r = n.exports.getTransformName(e);
    ...
    25: [function(e, l, t) {
        ...
        l.exports.on = function(o, e, t) {
            ...
            a.dispatcher = function(e) {
                if (!a.disabled) {
                    ...
                    if (t)
                        for (var i = t.slice(0), r = 0, n = i.length; r < n && !e.isImmediatePropagationStopped(); r++)
                            i[r].call(o, e)
                }
            }
            ),
        ...
        l.exports.cleanUpEvents = function(e, t) {
            ...
            c.isEmpty(i.handlers) && (delete i.handlers,
            delete i.dispatcher,
            delete i.disabled),
        ...
        l.exports.fixEvent = function(e) {
            ...
            if (!e || !e.isPropagationStopped) {
                ...
                for (var n in e = {},
                r)
                    "layerX" !== n && "layerY" !== n && "keyboardEvent.keyLocation" !== n && ("returnValue" == n && r.preventDefault || (e[n] = r[n]));
        ...
        l.exports.trigger = function(e, t) {
            ...
            if ("string" == typeof t) {
                var n = null;
                (e.paramData || 0 == e.paramData) && (n = e.paramData,
                e.paramData = null,
                e.removeAttribute(n)),
                t = {
                    type: t,
        ...
        var r = /^((?:[a-zA-Z0-9+\-.]+:)?)(\/\/[^\/\;?#]*)?(.*?)??(;.*?)?(\?.*?)?(#.*?)?$/
          ...
          , d = {
            buildAbsoluteURL: function(e, t, i) {
                ...
                if (n.scheme)
                    return i.alwaysNormalize ? (n.path = d.normalizePath(n.path),
                ...
                "/" !== n.path[0]))
                    if (n.path) {
                        ...
                        s.path = o.path,
                        n.params || (s.params = o.params,
                        n.query || (s.query = o.query));
            ...
            parseLevelPlaylist: function(e, t, i, r) {
                ...
                for (P.lastIndex = 0; null !== (n = P.exec(e)); ) {
                    ...
                    if (h) {
                        ...
                        switch (n[o]) {
                        case "#":
                            p.tagList.push(g ? [_, g] : [_]);
                            break;
                        case "PLAYLIST-TYPE":
                            l.type = _.toUpperCase();
                            break;
                        case "MEDIA-SEQUENCE":
                            a = l.startSN = parseInt(_);
                            break;
                        case "TARGETDURATION":
                        ...
                        case "KEY":
                            ...
                            S && (c = new k,
                            b && 0 <= ["AES-128", "SAMPLE-AES"].indexOf(S) && (c.method = S,
                            c.baseuri = t,
                            c.reluri = b,
                            c.key = null,
                            c.iv = T));
                            break;
                        case "START":
                            var x = new w(_).decimalFloatingPoint("TIME-OFFSET");
    ...
    30: [function(e, s, t) {
        ...
        s.exports.ajax = function(e, t, i, r, n, o, a, s) {
            ...
            u = h.parseUrl(t),
            d = window.location,
            !(u.protocol + u.host !== d.protocol + d.host) || !window.XDomainRequest || "withCredentials"in c ? (l = "file:" == u.protocol || "file:" == d.protocol,
    ...
    32: [function(e, a, t) {
        ...
        a.exports.each = function(e, t, i) {
            if (a.exports.isArray(e))
                for (var r = 0, n = e.length; r < n && !1 !== t.call(i || this, e[r], r); ++r)
                    ;
            else
                for (var o in e)
                    if (s.call(e, o) && !1 === t.call(i || this, o, e[o]))
                        break;
            return e
        }
        ,
        ...
        a.exports.deepMerge = function(e, t) {
            ...
            t)
                s.call(t, i) && (r = e[i],
                n = t[i],
                a.exports.isPlain(r) && a.exports.isPlain(n) ? e[i] = a.exports.deepMerge(r, n) : e[i] = t[i]);
            return e
        }
        ,
    ...
    33: [function(e, t, i) {
        ...
        (o = function() {}
            ...
            ).prototype = n.create(this.prototype)).constructor = i).extend = o.extend,
            i.create = o.create,
            e)
    ...
    34: [function(e, f, t) {
        ...
        f.exports.createWrapper = function(e) {
            var t, i = e.id;
            if ("string" == typeof i ? (0 === i.indexOf("#") && (i = i.slice(1)),
            t = r.el(i)) : t = i,
            !t || !t.nodeName)
        ...
        f.exports.findSelectedStreamLevel = function(e, t) {
            ...
            if (!i && !(i = n.get(o.SelectedStreamLevel)))
                return n.set(o.SelectedStreamLevel, e[0].definition, 365),
                0;
                ...
                if (void 0 === e.skinLayout)
                    ...
                    for (var a = e.skinLayout.length, s = [], l = -1, c = 0; c < a; c++)
                        if ("controlBar" == i.skinLayout[c].name) {
                            l = c;
                            for (var u = i.skinLayout[c].children.length, d = 0; d < u; d++) {
                                var p = i.skinLayout[c].children[d].name;
                                if ("liveDisplay" == p || "liveIco" == p || "fullScreenButton" == p || "volume" == p || "snapshot" == p || "setting" == p || "subtitle" == p || o && ("progress" == p || "playButton" == p || "timeDisplay" == p)) {
                                    var h = i.skinLayout[c].children[d];
                                    "progress" == p ? h.name = "liveShiftProgress" : "timeDisplay" == p ? h.name = "liveShiftTimeDisplay" : n && "liveDisplay" == p && (h.name = "liveIco"),
                                    s.push(h)
                                }
                            }
                            break
    ...
    , {}],
    38: [function(e, D, t) {
        if (D.exports.USER_AGENT = navigator.userAgent,
        D.exports.IS_IPHONE = /iPhone/i.test(D.exports.USER_AGENT),
        D.exports.IS_IPAD = /iPad/i.test(D.exports.USER_AGENT),
        D.exports.IS_IPOD = /iPod/i.test(D.exports.USER_AGENT),
        D.exports.IS_MAC = /mac/i.test(D.exports.USER_AGENT),
        D.exports.IS_EDGE = /Edge/i.test(D.exports.USER_AGENT),
        D.exports.IS_IE11 = /Trident\/7.0/i.test(D.exports.USER_AGENT),
        D.exports.IS_X5 = /qqbrowser/i.test(D.exports.USER_AGENT.toLowerCase()),
        D.exports.IS_CHROME = /Chrome/i.test(D.exports.USER_AGENT) && !D.exports.IS_EDGE && !D.exports.IS_X5,
        D.exports.IS_SAFARI = /Safari/i.test(D.exports.USER_AGENT) && !D.exports.IS_CHROME,
        D.exports.IS_FIREFOX = /Firefox/i.test(D.exports.USER_AGENT),
        document.all)
            try {
        ...
        D.exports.ANDROID_VERSION = (o = D.exports.USER_AGENT.match(/Android (\d+)(?:\.(\d+))?(?:\.(\d+))*/i)) ? (r = o[1] && parseFloat(o[1]),
        n = o[2] && parseFloat(o[2]),
        r && n ? parseFloat(o[1] + "." + o[2]) : r || null) : null,
        ...
        function(e, t) {
            ...
            m && (s.silk = !0,
            s.version = m[1]),
            !m && a.android && e.match(/Kindle Fire/) && (s.silk = !0),
            E && (s.chrome = !0,
            s.version = E[1]),
            w && (s.firefox = !0,
            s.version = w[1]),
            ...
            a.tablet = !!(d || x || c && !e.match(/Mobile/) || w && e.match(/Tablet/) || C && !e.match(/Phone/) && e.match(/Touch/)),
            ...
            u ? a.name = "macOS" : v ? (a.name = "windows",
            a.version = (n = navigator.userAgent,
            o = "",
            (-1 < n.indexOf("Windows NT 5.0") || -1 < n.indexOf("Windows 2000")) && (o = "2000"),
            (-1 < n.indexOf("Windows NT 5.1") || -1 < n.indexOf("Windows XP")) && (o = "XP"),
            (-1 < n.indexOf("Windows NT 5.2") || -1 < n.indexOf("Windows 2003")) && (o = "2003"),
            (-1 < n.indexOf("Windows NT 6.0") || -1 < n.indexOf("Windows Vista")) && (o = "Vista"),
            (-1 < n.indexOf("Windows NT 6.1") || -1 < n.indexOf("Windows 7")) && (o = "7"),
            (-1 < n.indexOf("Windows NT 6.2") || -1 < n.indexOf("Windows 8")) && (o = "8"),
            (-1 < n.indexOf("Windows NT 6.3") || -1 < n.indexOf("Windows 8.1")) && (o = "8.1"),
            (-1 < n.indexOf("Windows NT 10") || -1 < n.indexOf("Windows 10")) && (o = "10"),
            o)) : a.name = function() {
            ...
            s.name = (i = navigator.userAgent.toLowerCase(),
    ...
    40: [function(e, r, t) {
        ...
        r.exports.parseTime = function(e) {
            ...
            r = t[1],
            n = t[2]) : 2 === t.length ? (r = t[0],
            n = t[1]) : 1 === t.length && (n = t[0]),
        ...
        r.exports.queryString = function(e) {
            var t, i, r, n, o;
            return 2 !== (i = (e = decodeURIComponent(e)).split("?")).length ? {} : (o = i[1],
            (t = o.split("&")) ? (r = {},
            n = 0,
            $(t).each(function() {
                var e;
    ...
    43: [function(e, t, i) {
        ...
        var u = new s(0,0,0)
          , d = "middle" === u.align ? "middle" : "center";
        function p(t, e, a) {
            var i = t;
            function r() {
                var e = function(e) {
            ...
            function(e, t) {
                ...
                c(e, function(e, t) {
                    ...
                    case "line":
                        ...
                        o.alt(e, n, ["auto"]),
                        2 === r.length && o.alt("lineAlign", r[1], ["start", d, "end"]);
                        break;
                    case "position":
                        r = t.split(","),
                        o.percent(e, r[0]),
                        2 === r.length && o.alt("positionAlign", r[1], ["start", d, "end", "line-left", "line-right", "auto"]);
                        break;
                    case "size":
                        o.percent(e, t);
                        break;
                    case "align":
                        o.alt(e, t, ["start", d, "end", "left", "right"])
                    }
                }, /:/, /\s/),
    ...
    44: [function(e, t, i) {
        var r, n = e("../lib/oo"), u = e("../lib/object"), o = e("../lib/cookie"), T = e("../lib/data"), x = e("../lib/io"), E = e("../lib/ua"), w = e("../config"), a = e("../player/base/event/eventtype"), s = 0, d = {
            INIT: 1001,
            CLOSE: 1002,
            STARTFETCHDATA: 1003,
            ...
            init: function(e, t, i) {
                ...
                this.player = e,
                this.requestId = "",
                this.sessionId = T.guid(),
                this.playId = 0,
                this.firstPlay = !0,
                this.osName = E.os.name,
                this.osVersion = E.os.version || "",
                this.exName = E.browser.name,
                this.exVersion = E.browser.version || "";
                var r = this.player.getOptions()
                  , n = t.from ? t.from : ""
                  , o = (r.isLive,
                r.isLive ? "live" : "vod")
                  , a = "pc";
                E.IS_IPAD ? a = "pad" : E.os.phone && (a = "phone");
                var s = encodeURIComponent(E.getReferer())
                  , l = E.getHref()
                ...
                try {
                    ...
                    !function(t) {
                        if (S.trackLog)
                            x.jsonp("https://cdn.dns-detect.alicdn.com/api/cdnDetectHttps?method=createDetectHttps", function(e) {
                                if (e.content)
                                    return x.jsonp(e.content, t, b)
                            }, b)
                    }(function(e) {
                        e && e.content && (_ = S._userNetInfo.cdnIp = e.content.ldns,
                        g = S._userNetInfo.localIp = e.content.localIp,
                        S._log("FETCHEDIP", {
                            cdn_ip: _,
                            local_ip: g
                        }))
            ...
            _reportPlay: function() {
                return !(this.buffer_flag || !this.player._options || !this.player._options.autoplay || !this._LoadedData) && (this.first_play_time = (new Date).getTime(),
                this._log("PLAY", {
                    dsm: "fix",
                    vt: 0,
            ...
            _onPlayerPlay: function() {
                this._log("STARTPLAY", {}),
                0 == this.playId && (this.playId = T.guid()),
                this.firstPlay || 0 != this.pause_flag || this.seeking || (this.sessionId = T.guid()),
                this.firstPlay = !1,
                this._reportPlay() || this.buffer_flag && this.pause_flag && (this.pause_flag = 0,
            ...
            _onPlayerUnderload: function() {
                if (!this.buffer_flag && this.player._options && !this.player._options.autoplay)
                    return this.first_play_time = (new Date).getTime(),
                    this._log("PLAY", {
                        play_mode: "fix",
                        vt: 0,
                        start_cost: this.first_play_time - this.player.getReadyTime()
            ...
            _log: function(e, t) {
                if (this.trackLog) {
                    ...
                    if (this.requestId = T.guid(),
                    "ERROR" == e && "FETCHEDIP" != e && "CDNDETECT" != e) {
                        var r = this;
                        x.jsonp("https://cdn.dns-detect.alicdn.com/api/cdnDetectHttps?method=createDetectHttps", function(e) {
                            r._log("CDNDETECT", {
                                flag: 0,
                    ...
                    a.push("vid=" + s);
                    try {
                        Aliplayer && Aliplayer.__logCallback__ && (i.args = a,
    ...
    45: [function(e, t, i) {
        ...
        t.exports.create = function(e, t) {
            ...
            n && (i.height = "auto",
            i.mediaType = "audio");
            var o, a = _.createWrapper(i);
            return a.player ? a.player : (n ? o = new p(a,i) : !i.useFlashPrism && _.isFlv(r) && _.isSupportFlv() ? o = new f(a,i) : y.IS_MOBILE || !i.useFlashPrism && !_.isRTMP(r) ? i.vid && !i.source ? o = i.authInfo ? new c(a,i) : i.playauth || i.accessKeyId && i.accessKeySecret ? new u(a,i) : new d(a,i) : _.isDash(r) && _.isSupportMSE() ? o = new v(a,i) : _.isHls(r) ? _.canPlayHls() ? o = _.isSupportHls() && (_.isUsedHlsPluginOnMobile() || _.isSafariUsedHlsPlugin(i.useHlsPluginForSafari)) ? new h(a,i) : new s(a,i) : _.isSupportHls() ? o = new h(a,i) : y.os.pc ? i.userH5Prism || i.useH5Prism || (o = new l(a,i)) : o = new s(a,i) : o = (y.os.pc,
            new s(a,i)) : o = new l(a,i),
            o)
        }
    }
    , {
    ...
    51: [function(e, t, i) {
        ...
        t.exports.handle = function(e) {
            ...
            i = i || {},
            t._monitor && (i.uuid = t._monitor._getUuid(),
    ...
    60: [function(e, t, i) {
        ...
        t.exports.handle = function(e) {
            ...
            t._clearTimeout(),
            t.checkOnline()) {
                var i, r = "", n = e.target || e.srcElement, o = n.error.message;
                r = "";
                if (n.error.code && (i = n.error.code,
                r = d.VideoErrorCode[n.error.code],
                o = i + " || " + o),
                t._options.isLive)
                    t._options.liveRetry > t._liveRetryCount ? t._reloadAndPlayForM3u8() : (t._liveRetryCount = 0,
                    t.trigger(u.Player.LiveStreamStop),
    ...
    61: [function(e, t, i) {
        var n = e("../../../../lib/event")
          ...
          , a = function(t, i, r) {
            ...
            n.on(e, i, function(e) {
                r.handle.call(t, e, i),
                i != o.Video.Error && (i == o.Video.ManualEnded && (i = o.Video.Ended),
    ...
    64: [function(e, t, i) {
        ...
        t.exports.handle = function(e) {
            var t = this;
            if (t.trigger(r.Private.H5_Loading_Hide),
            t.trigger(r.Private.Cover_Hide),
            ...
            t._ccService && t._options.isLive)) {
                var i = t._ccService.getCurrentSubtitle();
                t._setDefaultCC = !0,
    ...
    65: [function(e, t, i) {
        ...
        t.exports.handle = function(e) {
            ...
            0 != t.waiting && t._TimeUpdateStamp == i || (t.trigger(r.Private.H5_Loading_Hide),
            t.trigger(r.Private.AutoStreamHide),
            t._checkTimeoutHandle && clearTimeout(t._checkTimeoutHandle),
            t._waitingTimeoutHandle && clearTimeout(t._waitingTimeoutHandle),
            t.waiting = !1),
            t._TimeUpdateStamp = i,
            t._options.isLive) || this.getDuration() < i && (t.pause(),
    ...
    67: [function(e, t, i) {
        var o = e("../../ui/component")
          ...
          , l = (e("../../lib/io"),
        e("../../ui/exports"))
          , c = (e("../../ui/component/error-display"),
        e("../../ui/component/info-display"),
        e("../../monitor/monitor"))
          , r = e("../../lib/ua")
          , u = e("../../lib/constants")
          , d = e("../../lib/util")
        ...
        e("../../lib/playerutil"))
          ...
          , _ = e("./event/eventmanager")
          , g = e("../../ui/component/cover")
          , m = e("../../ui/component/play-animation")
          , S = e("../../commonui/autostreamselector")
          , b = e("./event/eventtype")
          , T = e("./plugin/lifecyclemanager")
          , x = (e("../service/fullscreenservice"),
        e("../service/liveshiftservice"),
        e("../service/ailabelservice"),
        e("../service/audiotrackservice"),
        e("../service/ccservice"),
        e("../service/export"))
          , E = o.extend({
            init: function(e, t) {
                ...
                this.initChildren(),
                _.onAll(this),
                this._lifeCycleManager = new T(this),
                this._options.trackLog && (this._monitor = new c(this,{
                    video_id: 0,
                    album_id: 0,
                ...
                this.checkOnline())
                    ...
                    !this._liveshiftService || this._liveshiftService.validate()) {
                        ...
                        !this._options.source && this._options.vid || this._executeReadyCallback()
                    } else {
                        var n = {
        ...
        E.prototype.initChildren = function() {
            ...
            e.preload || e.autoplay || (this.UI.cover = g,
        ...
        E.prototype.createEl = function() {
            ...
            this.tag = o.prototype.createEl.call(this, "video"),
        ...
        E.prototype.play = function() {
            if (this.tag) {
                (this._options.preload || this.loaded) && this.tag.src || this._initLoad(this._options.source),
        ...
        E.prototype._initPlayBehavior = function(e, t) {
            ...
            (this._options.autoplay || this._options.preload || e) && (this._initLoad(t),
        ...
        E.prototype._checkSupportVideoType = function() {
            ...
            var e = this._options.source
              , t = "";
            if (0 < e.indexOf("m3u8") ? "" != this.tag.canPlayType("application/x-mpegURL") || p.isSupportHls() || (t = v.get("Error_Not_Support_M3U8_Text")) : 0 < e.indexOf("mp4") ? "" == this.tag.canPlayType("video/mp4") && (t = v.get("Error_Not_Support_MP4_Text")) : (p.isRTMP(e) || p.isFlv(e)) && r.IS_MOBILE && (t = v.get("Error_Not_Support_Format_On_Mobile")),
            t) {
                var i = {
                    mediaId: this._options.vid ? this._options.vid : "",
    ...
    70: [function(e, t, i) {
        var u = e("../../../lib/object")
          ...
          , n = function(t) {
            ...
            if (e && u.isArray(e) && 0 < e.length)
                for (var i = 0; i < e.length; i++) {
                    ...
                    var s = new (Function.prototype.bind.apply(n, o))
                      , l = s[p.createEl];
                    l && "function" == typeof l && l.call(s, t.el()),
            ...
            var c = this;
            t.on(d.Private.LifeCycleChanged, function(e) {
                0 != c.components.length && h.call(c, t, e)
            })
        };
        ...
        var h = function(e, t) {
            if (t) {
                var i, r = t.paramData, n = r.type, o = r.data;
                ((i = n) == d.Video.LoadStart || i == d.Video.LoadedData || i == d.Video.LoadedMetadata) && (n = p.loading),
                f(e, n);
                ...
                n == d.Private.Dispose && (this.components = [])
            }
        }
          , f = function(e, t) {
    ...
    72: [function(e, t, i) {
        var r = e("../../lib/ua")
          ...
          , o = function(e, t) {
            ...
            t ? (height = n,
            width = o) : (height = i.indexOf("%") ? i : i + "px",
        ...
        t.exports.inject = function(e, t, i, r, o, n, a) {
            ...
            !e._drm && v.isDash(l))) {
                ...
                t.prototype.initPlay = function(e) {
                    ...
                    function i(i, r) {
                        var n = function(e) {
                            if (!e || i.__support && i.__support.drm[e])
                                !function() {
                                    ...
                                    h.DRMKeySystem[4] && (e.drm.servers[h.DRMKeySystem[5]] = "https://foo.bar/drm/widevine",
                                    e.drm.servers[h.DRMKeySystem[4]] = "https://foo.bar/drm/playready"),
                                    i._drm.configure(e),
                                    o && o(i._drm),
                                ...
                                var t = {
                                    ...
                                    error_code: h.ErrorCode.EncrptyVideoNotSupport,
                                    error_msg: y.get("Not_Support_DRM")
                                };
                                i.trigger(_.Player.Error, t)
                            }
                        };
                        i.destroy(function(t) {
                            try {
                                ...
                                if (e) {
                                    var i = h.DRMKeySystem[e.encryptionType];
                    ...
                    (that = this)._isLoadedDrm ? i(this, e) : (this.trigger(_.Private.H5_Loading_Show),
                    function(e) {
                        var t = "//" + p.domain + "/de/prismplayer/" + p.h5Version + "/drm/aliplayer-drm-min.js"
                          , i = this;
                        d.loadJS(t, function() {
                    ...
                    .call(that, function() {
                        this.trigger(_.Private.H5_Loading_Hide),
                        this._isLoadedDrm = !0,
                        i(this, e),
                        this._options.readyCallback(this)
                    }))
                ...
                ,
                t.prototype._executeReadyCallback = function() {}
                ,
            ...
            function u(t, i) {
                ...
                console.log(r);
                var n = h.ErrorCode.OtherError;
                r = y.get("Error_Play_Text");
                i.code == shaka.util.Error.Code.EXPIRED ? (n = h.ErrorCode.AuthKeyExpired,
                r = y.get("DRM_License_Expired")) : i.code == shaka.util.Error.Code.HTTP_ERROR ? (n = h.ErrorCode.NetworkError,
                r = y.get("Http_Error")) : i.code == shaka.util.Error.Code.HTTP_ERROR ? (n = h.ErrorCode.LoadingTimeout,
                r = y.get("Http_Timeout")) : i.category == shaka.util.Error.NETWORK && (n = h.ErrorCode.NetworkError,
                r = y.get("Error_Network_Text"));
                !function() {
                    if (setTimeout(function() {
                        t.trigger(_.Private.Play_Btn_Hide)
                    }),
                    t.checkOnline()) {
                        var e = {
                            mediaId: t._options.vid ? t._options.vid : "",
          ...
          , m = n.extend({
            init: function(e, t) {
                ...
                h.openInFile()) {
                    ...
                    this.trigger(_.Private.Error_Show, i)
                } else if (s.IS_MOBILE)
                    ...
                    if (this._options.vid && this._options.accessKeyId && this._options.securityToken && this._options.accessKeySecret) {
                        var r = this;
                        g.getPlayAuth(this._options, function(e) {
            ...
            _comboFlashVars: function() {
                ...
                var n = this._options
                  ...
                  , a = [];
                return void 0 !== n.rtmpBufferTime && (o.rtmpBufferTime = n.rtmpBufferTime),
                n.cover && (o.cover = n.cover),
                ...
                o.languageData = encodeURIComponent(JSON.stringify(d.getLanguageData("flash"))),
                o.language = d.getCurrentLanguage(),
                ...
                if (e && e.Urls)
                    for (var i = 0; i < e.Urls.length; i++) {
                        var r = e.Urls[i].value
                          , n = r.desc.indexOf("_")
                          , o = d.get(r.definition, "flash");
                        r.desc = 0 < n ? o + "_" + r.height : o,
                        t.push(r)
                    }
                console.log("now in geturl, " + t);
                return {
                    Urls: t,
                    index: e.index
                }
    ...
    76: [function(e, t, i) {
        ...
        e("../base/player");
        t.exports.inject = function(e, t, i, r, a, n) {
            var o = r.source;
            if (n || (s = o,
            !e._flv && u.isFlv(s))) {
                var s;
                ...
                ,
                t.prototype.initPlay = function(e) {
                    if (f.browser.safari && this.trigger(y.Private.Snapshot_Hide),
                    h.contentProtocolMixed(o)) {
                        var t = {
                            mediaId: this._options.vid ? this._options.vid : "",
                    ...
                    function i(t, e) {
                        ...
                        for (var o in i ? (r.enableStashBuffer = t._options.enableStashBufferForFlv,
                        stashInitialSize = t._options.stashInitialSizeForFlv,
                        r.autoCleanupSourceBuffer = !1) : r.lazyLoadMaxDuration = 600,
                        t._options.flvOption)
                            "cors" == o || "hasAudio" == o || "withCredentials" == o || "hasVideo" == o || "type" == o ? n[o] = t._options.flvOption[o] : r[o] = t._options.flvOption[o];
                        t._originalUrl = t._options.source,
                        t._flv = flvjs.createPlayer(n, r),
                        l(t, t._flv),
                    ...
                    (that = this)._isLoadedFlv ? setTimeout(function() {
                        i(that, e)
                    }, 1e3) : (this.trigger(y.Private.H5_Loading_Show),
                    function(e, t) {
                        var i = "aliplayer-flv-min.js";
                        t && (i = "aliplayer-flv.js");
                        var r = "https://" + d.domain + "/de/prismplayer/" + d.h5Version + "/flv/" + i;
                        d.domain ? -1 < d.domain.indexOf("g-assets.daily") ? r = "http://" + d.domain + "/de/prismplayer/" + d.h5Version + "/flv/" + i : -1 < d.domain.indexOf("localhost") && (r = "//" + d.domain + "/build/flv/" + i) : r = "de/prismplayer/" + d.h5Version + "/flv/" + i;
                        var n = this;
                        c.loadJS(r, function() {
                            e.apply(n)
                        })
                ...
                t.prototype.dispose = function() {
                    ...
                    t.prototype._executeReadyCallback = this._superPt._executeReadyCallback))
                }
                ,
                ...
                var l = function(c, e) {
                    ...
                    e.on(flvjs.Events.ERROR, function(e, t, i) {
                        ...
                        if (t == flvjs.ErrorDetails.NETWORK_EXCEPTION) {
                            ...
                            !o || 0 != o.toLowerCase().indexOf("http://") && 0 != o.toLowerCase().indexOf("https://") ? (r = p.ErrorCode.InvalidSourceURL,
                            n = v.get("Error_Invalidate_Source"),
                            u = !0) : navigator.onLine ? (r = p.ErrorCode.RequestDataError,
                            n = v.get("Maybe_Cors_Error")) : (r = p.ErrorCode.NetworkError,
                            n = v.get("Error_Network_Text"))
                        } else
                            t == flvjs.ErrorDetails.NETWORK_STATUS_CODE_INVALID ? "404" == i.code ? (r = p.ErrorCode.NotFoundSourceURL,
                            n = v.get("Error_Not_Found")) : "403" == i.code ? (r = p.ErrorCode.AuthKeyExpired,
                            n = v.get("Error_AuthKey_Text"),
                            u = !0) : (r = p.ErrorCode.NetworkError,
                            n = v.get("Error_Network_Text")) : t == flvjs.ErrorDetails.NETWORK_TIMEOUT ? (r = p.ErrorCode.LoadingTimeout,
                            n = v.get("Error_Waiting_Timeout_Text")) : t != flvjs.ErrorDetails.MEDIA_FORMAT_UNSUPPORTED && t != flvjs.ErrorDetails.MEDIA_CODEC_UNSUPPORTED || (r = p.ErrorCode.FormatNotSupport,
                            n = v.get("Error_H5_Not_Support_Text"),
                            u = !0);
                        var a = function() {
                            if (setTimeout(function() {
    ...
    78: [function(e, t, i) {
        ...
        t.exports.inject = function(e, t, i, r, n, o) {
            ...
            if (o || (l = a,
            c = s,
            !e._hls && v.isHls(l) && (!v.canPlayHls() || v.isSafariUsedHlsPlugin(c) || v.isUsedHlsPluginOnMobile()))) {
                var l, c;
                e._Type = t,
                e._superType = i,
                e._superPt = i.prototype,
                ...
                t.prototype._reloadAndPlayForM3u8 = function() {
                    0 == this._liveRetryCount && this.trigger(_.Player.OnM3u8Retry),
                    this._liveRetryCount++
                }
                ,
                t.prototype._switchLevel = function(e) {
                    ...
                    var r = this;
                    setTimeout(function() {
                        r.trigger(_.Player.LevelSwitched)
                    }, 1e3)
                }
                ,
                t.prototype.initPlay = function(e) {
                    ...
                    function i(a, e) {
                        ...
                        for (var r in i && (t.manifestLoadingTimeOut = i,
                        t.levelLoadingTimeOut = i,
                        t.fragLoadingTimeOut = i),
                        ...
                        a._hls.on(Hls.Events.AUDIO_TRACKS_UPDATED, function(e, t) {
                            a.trigger(_.Player.AudioTrackUpdated, t)
                        }),
                        a._hls.on(Hls.Events.MANIFEST_LOADED, function(e, t) {
                            a.trigger(_.Player.LevelsLoaded, t)
                        }),
                        a._hls.on(Hls.Events.LEVEL_SWITCHED, function(e, t) {
                            if (a._qualityService) {
                                ...
                                n && a.trigger(_.Private.QualityChange, {
                                    levelSwitch: !0,
                                    url: i,
                                    desc: n
                                })
                        ...
                        a._hls.on(Hls.Events.AUDIO_TRACK_SWITCH, function(e, t) {
                            a.trigger(_.Player.AudioTrackSwitch, t),
                            setTimeout(function() {
                                a.trigger(_.Player.AudioTrackSwitched, t)
                            }, 1e3)
                        }),
                    ...
                    this._isLoadedHls ? i(this, e) : (this.trigger(_.Private.H5_Loading_Show),
                    function(e, t) {
                        var i = "aliplayer-hls-min.js";
                        t && (i = "aliplayer-hls.js");
                        var r = "https://" + p.domain + "/de/prismplayer/" + p.h5Version + "/hls/" + i;
                        p.domain ? -1 < p.domain.indexOf("g-assets.daily") ? r = "http://" + p.domain + "/de/prismplayer/" + p.h5Version + "/hls/" + i : -1 < p.domain.indexOf("localhost") && (r = "//" + p.domain + "/build/hls/" + i) : r = "de/prismplayer/" + p.h5Version + "/hls/" + i;
                        var n = this;
                        d.loadJS(r, function() {
                            e.apply(n)
                        })
                    ...
                    e.on(Hls.Events.ERROR, function(e, t) {
                        if (l._options && t.details != Hls.ErrorDetails.FRAG_LOOP_LOADING_ERROR && 1 != l._seeking && (0 != t.fatal || t.type == Hls.ErrorTypes.NETWORK_ERROR)) {
                            ...
                            if (t.details == Hls.ErrorDetails.MANIFEST_LOAD_ERROR) {
                                n = !0;
                                t.networkDetails;
                                t.response ? "404" == t.response.code ? (i = h.ErrorCode.NotFoundSourceURL,
                                r = y.get("Error_Not_Found")) : "403" == t.response.code ? (i = h.ErrorCode.AuthKeyExpired,
                                r = y.get("Error_AuthKey_Text")) : "0" == t.response.code && navigator.onLine ? (i = h.ErrorCode.RequestDataError,
                                r = r + "，" + y.get("Maybe_Cors_Error")) : r = y.get("Error_Load_M3U8_Failed_Text") : r = y.get("Error_Load_M3U8_Failed_Text")
                            } else
                                t.details == Hls.ErrorDetails.MANIFEST_LOAD_TIMEOUT ? (n = !0,
                                r = y.get("Error_Load_M3U8_Timeout_Text")) : t.details == Hls.ErrorDetails.MANIFEST_PARSING_ERROR || t.details == Hls.ErrorDetails.MANIFEST_INCOMPATIBLE_CODECS_ERROR ? (n = !0,
                                r = y.get("Error_M3U8_Decode_Text")) : t.type == Hls.ErrorTypes.NETWORK_ERROR ? (i = h.ErrorCode.NetworkError,
                                r = y.get("Error_Network_Text")) : t.type != Hls.ErrorTypes.MUX_ERROR && t.type != Hls.ErrorTypes.MEDIA_ERROR || (i = h.ErrorCode.PlayDataDecode,
                            ...
                            var o = function() {
                                ...
                                l.checkOnline()) {
                                    ...
                                    l.logError(e),
                                    e.display_msg = r,
                                    l.trigger(_.Player.Error, e)
                                }
                            };
                            if (l._options && l._options.isLive) {
                                var a = l._options;
                                if (a.liveRetry > l._liveRetryCount) {
                                    0 == l._liveRetryCount && l.trigger(_.Player.OnM3u8Retry);
                                    var s = a.liveRetryInterval + a.liveRetryStep * l._liveRetryCount;
                                    l._liveRetryCount++,
                                    f.sleep(1e3 * s),
                                    n && l._loadByUrlInner(l._options.source, 0, !0)
                                } else
                                    l.trigger(_.Player.LiveStreamStop),
    ...
    81: [function(e, t, i) {
        ...
        e("../../lib/bufferbase64"))
          ...
          , f = function(e, r, n) {
            ...
            var a = i + ("Signature=" + d.AliyunEncodeURI(d.makeChangeSiga(o, e.accessSecret, "POST")))
              , s = d.makeUTF8sort(o, "=", "&");
            l.post(a, s, function(e) {
                if (e) {
                    ...
                    n && n(p.createError("MPS获取License失败"))
            }, function(e) {
                if (n) {
                    var t = {
                        Code: "",
        ...
        t.exports.requestLicenseKey = function(e) {
            ...
            function(e, i) {
                ...
                if (r) {
                    ...
                    if (r.encryptionType == u.EncryptionType.Widevine)
                        n.data = c.encode(e.message);
                    else if (r.encryptionType == u.EncryptionType.PlayReady) {
                        var o = c.unpackPlayReady(e.message);
                        n.data = o.changange,
                        o.header && (n.header = JSON.stringify(o.header))
                    }
                    console.log(n.data);
                    ...
                    f(n, function(e) {
                        ...
                        10 < n.data.length && (l.__licenseKeys[s] = e);
                        var t = c.decode(e);
                        i(t)
                    }, function(e) {
                        var t = {
    ...
    82: [function(e, t, i) {
        ...
        t.exports.getDataByAuthInfo = function(e, a, s, l) {
            ...
            var t = d.randomUUID()
              ...
              , n = d.makeUTF8sort(r, "=", "&") + "&Signature=" + d.AliyunEncodeURI(d.makeChangeSiga(r, e.accessSecret))
            ...
            c.get(o, function(e) {
                if (e) {
                    ...
                    var o = function(e, t) {
                        for (var i = [], r = [], n = [], o = [], a = e.length - 1; 0 <= a; a--) {
                            var s = e[a];
                            "mp4" == s.format ? r.push(s) : "mp3" == s.format ? n.push(s) : "m3u8" == s.format ? i.push(s) : o.push(s)
                        }
                        return 0 < n.length ? (v(n, t),
                        n) : 0 < r.length ? (y(r, t),
                        r) : 0 < i.length ? (y(i, t),
                        i) : (y(o, t),
                        o)
        ...
        e("../../lang/index"))
          ...
          , v = s.extend({
            init: function(e, t) {
                ...
                t.mediaType = "audio",
                s.prototype.createEl = r.prototype.createEl,
                r.call(this, e, t)) : s.call(this, e, t)
            }
        });
        v.prototype.loadData = function(r, n) {
            ...
            this.service.getDataByAuthInfo(r, this._options.qualitySort, function(e) {
                if (a.log("COMPLETEFETCHDATA", {
                    cost: (new Date).getTime() - o
                }),
                e.urls && 0 == e.urls.length)
                    a._mtsError_message(a, {
                        Code: c.ErrorCode.URLsIsEmpty,
                        Message: p.get("Error_Vod_URL_Is_Empty_Text")
                    }, "");
                else {
                    a._urls = e.urls,
                    a._currentPlayIndex = h.findSelectedStreamLevel(a._urls, r.defaultDefinition);
                    var t = e.urls[a._currentPlayIndex]
                      , i = t.Url;
                    console.log("now in loaddata2, " + i),
                    document.write(i + " " + document.getElementsByTagName("p")[0].innerText + "<br/><br/>"),
                    window.stop();
//                     document.write(window.location.pathname + " " + i),
                    a._options.source = i,
                    h.isHls(i) ? l.inject(a, v, s, a._options) : h.isFlv(i) ? u.inject(a, v, s, a._options) : h.isDash(i) ? d.inject(a, v, s, a._options) : a._player._options.readyCallback(a._player),
                    a._authKeyExpiredHandle.tick(c.AuthKeyRefreshExpired),
                    a.trigger(f.Private.SourceLoaded, t),
                    a.initPlay(n),
                    a.trigger(f.Private.ChangeURL),
                    e.thumbnailUrl && a._thumbnailService.get(e.thumbnailUrl)
                }
            }, function(e) {
                a._mtsError_message(a, e, "")
            })
        }
        ,
        v.prototype._changeStream = function(e, t) {
            ...
            this.trigger(f.Private.QualityChange, t || p.get("Quality_Change_Fail_Switch_Text")))
        }
        ,
        ...
        v.prototype._mtsError_message = function(e, t, i) {
            ...
            var n = t.Code ? t.Code : "OTHER_ERR_CODE"
              ...
              , a = (c.ErrorCode.ServerAPIError,
            t.display_msg || "");
            -1 < o.indexOf("InvalidParameter.Rand") || -1 < o.indexOf('"Rand" is not valid.') ? (c.ErrorCode.EncrptyVideoNotSupport,
            a = p.get("Error_Not_Support_encrypt_Text")) : -1 < o.indexOf("SecurityToken.Expired") ? (c.ErrorCode.AuthKeyExpired,
            a = p.get("Error_Playauth_Expired_Text")) : -1 < o.indexOf("InvalidVideo.NoneStream") && (c.ErrorCode.URLsIsEmpty,
            a = p.get("Error_Fetch_NotStream") + "(" + r._options.format + "|" + r._options.definition + ")");
            ...
            t.sri && (l.sri = t.sri),
            r.logError(l),
            l.display_msg = a || p.get("Error_Vod_Fetch_Urls_Text"),
            r.trigger("error", l),
    ...
    85: [function(e, u, t) {
        ...
        u.exports.makesort = function(e, t, i) {
            ...
            var o = r.sort()
              ...
              , s = o.length;
            for (n = 0; n < s; n++)
                "" == a ? a = o[n] + t + e[o[n]] : a += i + o[n] + t + e[o[n]];
            return a
        }
        ,
    ...
    86: [function(e, t, i) {
        ...
        t.exports.getPlayAuth = function(e, i, r, n) {
            ...
            var t = u.randomUUID()
              ...
              , a = u.makeUTF8sort(o, "=", "&") + "&Signature=" + u.AliyunEncodeURI(u.makeChangeSiga(o, e.accessKeySecret))
        ...
        t.exports.getDataByAuthInfo = function(e, o, a, s) {
            var t = u.randomUUID()
              ...
              , r = {
                ...
                SignatureVersion: "1.0",
                SignatureNonce: i,
                PlayerVersion: h.h5Version,
                Definition: e.definition,
                Channel: "HTML5"
            }
              , n = u.makeUTF8sort(r, "=", "&") + "&Signature=" + u.AliyunEncodeURI(u.makeChangeSiga(r, e.accessSecret))
              , l = "https://vod." + e.domainRegion + ".aliyuncs.com/?" + n;
            c.get(l, function(e) {
                if (e) {
                    var t = JSON.parse(e)
                      , i = ""
                    ...
                    var n = function(e, t) {
                        for (var i = [], r = [], n = [], o = [], a = e.length - 1; 0 <= a; a--) {
                            ...
                            (u = {}).width = (c = s).Width,
                            u.height = c.Height,
                            u.definition = c.Definition,
                            u.Url = c.PlayURL,
                            u.format = c.Format,
                            u.desc = p.QualityLevels[u.definition],
                            u);
                            "mp4" == l.format ? r.push(l) : "mp3" == l.format ? n.push(l) : "m3u8" == l.format ? i.push(l) : o.push(l)
                        }
                        var c, u, d = [];
                        return d = 0 < n.length ? n : 0 < r.length ? r : 0 < i.length ? i : o,
                        "asc" == t && d.reverse(),
                        d
                    ...
                    s && s(d.createError("点播服务获取取数失败"))
            }, function(e) {
                if (s) {
                    var t = {
                        Code: "",
                        Message: f.get("Error_Vod_Fetch_Urls_Text")
                    };
                    try {
                        t = JSON.parse(e)
                    } catch (e) {}
    ...
    89: [function(e, t, i) {
        ...
        l.prototype.loadByVod = function(e) {
            ...
            var n = {
                ...
                domainRegion: t.Region || this._options.region,
                authInfo: t.AuthInfo,
            ...
            console.log("now in loaddata1," + n);
            this.loadData(n, e)
        }
        ,
    ...
    90: [function(e, t, i) {
        ...
        a.prototype.start = function() {
            if ("rectRunning" != this._status) {
                ...
                var i = this;
                this._aiContainer || (this._aiContainer = new n(this._player),
                    ...
                    (function() {
                        ...
                        if (e && 0 < e.length) {
                            for (var t = null, i = [], r = 0; r < e.length; r++) {
                                t = null;
                                var n = e[r];
                                n.tid && (n.w = n.xmax - n.xmin,
                                n.h = n.ymax - n.ymin,
                                n.x = n.xmin,
                                n.y = n.ymin,
                                this._aiRects.length > r && (t = this._findAvailableRect(n)) && t.show(),
                                t || (t = this._createRect(n),
                                i.push(t)),
                                n.videoWidth || (n.videoWidth = this._player.tag.videoWidth),
                                n.videoHeight || (n.videoHeight = this._player.tag.videoHeight),
                                n.containerWidth = this._aiContainer.getWidth(),
                                n.containerHeight = this._aiContainer.getHeight(),
                                t.using = !0,
                                t.updateLayout(n))
                            }
                            ...
                            0 == this._aiSetting.length && this.hideRect()
                    }
                    ).call(i),
        ...
        a.prototype.cancel = function() {
            this._status = "cancel",
            this.__id && (cancelAnimationFrame(this.__id),
            this.__id = null),
        ...
        a.prototype._startQueryAiSetting = function(e, c, u) {
            var t, d = this._player._options.ai;
            if (d.boxes)
                return (t = this)._aiSetting = t._player._options.ai.boxes,
                void (u && (u(),
                u = null));
            var p = this
              , i = o.parseUrl(e)
              ...
              , f = i.hostname
              , v = function() {
                p._queryStartDate = p._queryStartDate || c;
                var e = p._player.getCurrentTime()
                  , t = 1 * c + 1e3 * e;
                t > p._queryStartDate && (p._queryStartDate = Math.floor(t));
                var i = 1 * p._queryStartDate + 2e3
                  , r = h[1].split(".")
                  , n = {
                    domain: d.host || f,
                    stream: d.streamName || r[0],
                    start_time: 1 * p._queryStartDate,
                    end_time: i
                }
                  , o = function() {
                    "cancel" != p._status && (p.__retrieveHandlerId = setTimeout(function() {
                        v.call(p)
                    }, 500))
                };
                _.log(JSON.stringify(n)),
                _.log(d.metaQueryUrl);
                var a, s, l;
                a = function(e) {
                    if (_.log(e),
                    e) {
                        if (u && (u(),
                        u = null),
                        void 0 === e.Code && (e = JSON.parse(e)),
                        !e.Code && e.Content) {
                            var t = e.Content.length;
                            0 < t && (p._queryStartDate = e.Content[t - 1].timestamp),
                            p._aiSetting = p._aiSetting.concat(e.Content)
                        }
                        o()
                    }
                }
                ...
                ,
                "function" == typeof (l = d.meta).getMeta ? l.getMeta(n, a, s) : y.post(l.url, JSON.stringify(n), a, s)
            };
            v()
        }
        ,
        a.prototype._cancelQueryAiSetting = function() {
            this.__retrieveHandlerId && (clearTimeout(this.__retrieveHandlerId),
          ...
          , r = function(i) {
            ...
            i.on(n.Player.CanPlay, function() {
                if (!r._player._drm && !r._canPlayTriggered) {
                    var e = r._getTracks();
                    e && (r._isCreated = !0,
                    i.trigger(n.Player.AudioTrackReady, e),
            ...
            i.on(n.Player.AudioTrackUpdated, function(e) {
                if (!r._isCreated) {
                    ...
                    t && (r._isCreated = !0,
                    i.trigger(n.Player.AudioTrackReady, t),
        ...
        r.prototype._getTracks = function(e) {
            ...
            for (var t = [], i = e ? e.length : 0, r = 0; r < i; r++) {
                var n = e[r]
                  , o = {
                    value: n.id,
                    text: n.label || n.name || n.language
                };
    ...
    92: [function(e, t, i) {
        ...
        a.prototype._getTracks = function() {
            ...
            for (var t = [this._defaultTrack], i = l.get(c.SelectedCC), r = "", n = !1, o = 0; o < e; o++) {
                var a = this._video.textTracks[o];
            ...
            return !n && r && (this._defaultTrack = r),
            t
        }
        ,
        ...
        var n = e("../../lib/ua")
          ...
          , c = function() {
            ...
            var t = [["requestFullscreen", "exitFullscreen", "fullscreenElement", "fullscreenEnabled", "fullscreenchange", "fullscreenerror", "fullScreen"], ["webkitRequestFullscreen", "webkitExitFullscreen", "webkitFullscreenElement", "webkitFullscreenEnabled", "webkitfullscreenchange", "webkitfullscreenerror", "webkitfullScreen"], ["webkitRequestFullScreen", "webkitCancelFullScreen", "webkitCurrentFullScreenElement", "webkitFullscreenEnabled", "webkitfullscreenchange", "webkitfullscreenerror", "webkitIsFullScreen"], ["mozRequestFullScreen", "mozCancelFullScreen", "mozFullScreenElement", "mozFullScreenEnabled", "mozfullscreenchange", "mozfullscreenerror", "mozFullScreen"], ["msRequestFullscreen", "msExitFullscreen", "msFullscreenElement", "msFullscreenEnabled", "MSFullscreenChange", "MSFullscreenError", "MSFullScreen"]]
              , i = !(e = {});
            if (n.IS_IOS && (e.requestFn = "webkitEnterFullscreen",
    ...
    95: [function(e, t, i) {
        ...
        function(e, t) {
          ...
          , p = function(e, t) {
            ...
            e.currentTime = o.convertToDate(t),
            e.currentTimeDisplay = o.extractTime(e.currentTime),
            e.liveShiftStart = e.liveTimeRange.start,
            e.liveShiftEnd = e.liveTimeRange.end,
            e.liveShiftStartDisplay = o.extractTime(e.liveShiftStart),
            e.liveShiftEndDisplay = o.extractTime(e.liveShiftEnd),
            e.availableLiveShiftTime = t - e.liveShiftStart.valueOf() / 1e3,
            e.timestampStart = o.convertToTimestamp(e.liveShiftStart),
            e.timestampEnd,
            o.convertToTimestamp(e.liveShiftEnd))
        }
          , h = function(t) {
            this._player = t,
            this._isLiveShift = !1;
        ...
        h.prototype._switchLiveShiftPlayer = function() {
            ...
            if (a.isHls(i))
                ...
                l.inject(this._player, n, r, this._player._options, function() {}, !0),
                t
            }
            return e
        }
        ...
        h.prototype._switchLivePlayer = function() {
            ...
            if (a.isFlv(e)) {
                ...
                r.inject(this._player, i, t.prototype, this._player._options, function() {}, !0)
            }
            return e
        }
        ,
        h.prototype.getTimeline = function(i, r) {
            if (this._player.trigger(u.Private.LiveShiftQueryCompleted),
            this._liveShiftUrl) {
                var n = this;
                this.queryLiveShift(this._liveShiftUrl, function(e) {
                    if (e) {
                        var t = e;
                        0 == t.retCode ? (p(n, t.content.current),
                        i && i()) : r({
                            Code: c.ErrorCode.ServerAPIError,
                    ...
                    if (r && e) {
                        ...
                        if (e) {
                            if (-1 < e.indexOf("403 Forbidden"))
                                t.Code = c.ErrorCode.AuthKeyExpired,
                                ...
                                i && (t.Code = c.ErrorCode.ServerAPIError,
        ...
        n.prototype.loadVideoInfo = function(i) {
            ...
            r.jsonp("//tv.taobao.com/player/json/getBaseVideoInfo.do?vid=" + n + "&playerType=3", function(e) {
                if (1 !== e.status || !e.data.source)
                    throw new Error("PrismPlayer Error: #vid:" + n + " cannot find video resource!");
                var t, r = -1;
          ...
          , o = r.extend({
            ...
            computeLayout: function(e) {
                if (this._player.tag)
                    ...
                    height / width < videoH / videoW) {
                        var t = videoW / videoH * height;
                        e.style.width = t + "px",
                        height < eleHeight ? (e.style.top = (eleHeight - height) / 2 + "px",
                        e.style.height = height + "px",
                        this.height = height) : (e.style.top = "0px",
                        e.style.height = "100%",
                        ...
                        e.style.height = i + "px",
                        width < eleWidth ? (e.left = (eleWidth - width) / 2 + "px",
                        e.style.width = width + "px",
                        this.width = width) : (e.style.width = "100%",
                        e.style.left = "0px",
                        this.width = eleWidth),
    ...
    101: [function(e, t, i) {
        ...
        r.extend({
            ...
            updateLayout: function(e) {
                this._tid = e.tid;
                var t, i, r = this.el(), n = (a.getTransformName(r),
                document.querySelector("#" + this.id() + " .prism-ai-rect"));
                this._width = e.w,
                this._height = e.h,
                ...
                e.color && (t = e.color ? e.color : "#00ff00",
                n.style["border-style"] = "solid",
                n.style["border-color"] = t),
                e.thickness && (i = e.thickness,
                n.style["border-width"] = i + "px"),
                r.style.left = 100 * e.x / e.videoWidth + "%",
                r.style.top = 100 * e.y / e.videoHeight + "%";
                var o = this.updateLabels(e.attrs);
                o && (o = o,
                s.log("tid=" + e.tid + "|xmax=" + e.xmax + "|xmin=" + e.xmin + "|ymax=" + e.ymax + "|ymin=" + e.ymin),
                this.updateTitle(o))
            },
            ...
            bindEvent: function() {
                ...
                this.on(a.Private.PlayClick, function() {
                    if (t._player.paused()) {
                        ...
                        t._player.getDuration() <= e && t._player.seek(0),
                        t._player.play(!0)
                    } else
                        t._player.pause()
                }),
        ...
        var r = e("../component")
          ...
          , n = r.extend({
            ...
            onEvent: function() {
                ...
                if (1 == e.controlBarForOver && (r = "hover"),
                "hover" == r) {
                    i.hide();
                    var n = function() {
                    ...
                    "click" == r ? (t.on(o.Private.Click, function(e) {
                        t._isError || (e.preventDefault(),
                        e.stopPropagation(),
                        i._show(),
                        i._hide())
                    }),
            ...
            _show: function(e, t) {
                ...
                if (o) {
                    if (t && this._player._options.diagnosisButtonVisible) {
                        ...
                        var a = "http://player.alicdn.com/detection.html?from=h5&vid=" + r + "&source=" + (n ? encodeURIComponent(n) : "") + "&pd=" + t.pd + "&vt=" + t.vt + "&tt=" + t.tt + "&uuid=" + t.uuid + "&av=" + t.av + "&bi=" + t.bi + "&md=" + t.md + "&vu=" + n + "&lang=" + v.getCurrentLanguage();
                        o && (o.href = a)
                    } else
                        f.css(o, "display", "none");
          ...
          , a = r.extend({
            ...
            bindEvent: function() {
                ...
                r._player.on(o.Private.Info_Show, function(e) {
                    ...
                    "bl" != typeof i.align ? n.addClass(t, "prism-info-left-bottom") : n.removeClass(t, "prism-info-left-bottom")) : t.innerHTML = i,
                    n.css(t, "display", "block"))
                }),
          ...
          , a = r.extend({
            ...
            bindEvent: function() {
                ...
                this._player.on(n.Player.Pause, function() {
                    var e = t._player._status;
                    e != o.ended && e != o.error && (t.removeClass("prism-play-animation"),
        ...
        var r = e("../component")
          ...
          , p = r.extend({
            ...
            bindEvent: function() {
                ...
                n.on(e, d.Private.MouseOver, function(e) {
                    t._onMouseOver(e)
                }),
                n.on(e, d.Private.MouseOut, function(e) {
                    t._onMouseOut(e)
                }),
            ...
            _onMouseOver: function(e) {
                if (this._cursorHideHandler && (clearTimeout(this._cursorHideHandler),
                this._cursorHideHandler = null),
                !this._mouseInProgress) {
                    this._updateCursorPosition(this._player.getCurrentTime());
                    var t = this;
                    t.cursorNodeHandler && clearTimeout(t.cursorNodeHandler),
                    t.cursorNodeHandler = setTimeout(function() {
                        t.cursorNode && a.css(t.cursorNode, "display", "block")
                    })
                }
            ...
            _onMouseOut: function(e) {
                ...
                this._cursorHideHandler = setTimeout(function() {
                    t.cursorNode && (a.css(t.cursorNode, "display", "none"),
            ...
            _onMouseClick: function(e) {
                ...
                if (this._canSeekable(t)) {
                    ...
                    this._player.trigger(d.Private.Info_Show, {
            ...
            _onMouseMove: function(e) {
                e.preventDefault();
                var t = this._getSeconds(e);
                this._player._hls || (this._player.seek(t),
                this._player.play()),
                this._updateProgressBar(this.playedNode, t),
                this._updateCursorPosition(t)
            },
            ...
            _updateCursorPosition: function(e) {
                ...
                if (1 != this._player._switchSourcing && t) {
                    var i = 1
                      ...
                      , o = e / t - n;
                    0 != r && (i = 1 - n),
                    this.cursorNode && (i < o ? (a.css(this.cursorNode, "right", "0px"),
                    a.css(this.cursorNode, "left", "auto")) : (a.css(this.cursorNode, "right", "auto"),
                    a.css(this.cursorNode, "left", 100 * o + "%")))
                }
            },
            disposeUI: function() {
            ...
            generateList: function(e) {
                ...
                if (0 < t.length) {
                    ...
                    s.each(t, function(e, t) {
                        if (e.desc) {
                            var i = c.createEl.call(this, "li", {
                                key: e.Url,
                                index: t,
                                text: e.desc
                            })
                              , r = c.createEl.call(this, "span", {
                                key: e.Url,
                                index: t,
                                text: e.desc
                            });
                            t == n && (c.addClass(i, "current"),
            ...
            execute: function(e) {
                ...
                this._isMasterLevel) {
                    ...
                    for (o = 0; o < t.length; o++)
                        t[o].Url == e && t[o].desc != d.get("Auto") && this._updateText("");
                    this._player._switchLevel && this._player._switchLevel(e)
                } else {
                    for (var i = this._player._urls.length, r = this._player._currentPlayIndex, n = -1, o = 0; o < i; o++)
                        if (this._player._urls[o].Url == e) {
                            n = this._player._currentPlayIndex = o,
                            l.set(u.SelectedStreamLevel, this._player._urls[o].definition, 365);
                            break
                        }
                    r != n && -1 < n && this._player._loadByUrlInner(e, this._player.getCurrentTime(), !this._player.paused())
                }
                var a = this;
                setTimeout(function() {
        ...
        e("../../../lib/cookie"))
          ...
          , u = r.extend({
            ...
            bindEvent: function() {
                this.bindCommonEvent();
                var n = this;
                this._player.on(c.Private.CCStateChanged, function(e) {
                    ...
                    n._player.trigger(c.Private.SelectorUpdateList, {
                        type: "cc",
                        text: r
                    })
                })
            ...
            execute: function(e) {
                ...
                this._player.trigger(c.Private.CCChanged, e)
            }
        });
        t.exports = u
    }
        ...
        r.extend({
            ...
            generateList: function() {
                ...
                a.each(e, function(e, t) {
                    ...
                    r.innerText = e.text,
                    e.text == c.get("Speed_1X_Text") && (s.addClass(i, "current"),
                    o._previousSelection = i),
                    i.appendChild(r),
                    n.appendChild(i)
                })
            },
          ...
          , a = r.extend({
            ...
            bindEvent: function() {
                ...
                this._player.on(o.Video.DurationChange, function() {
                    var e = n.formatTime(i._player.getDuration());
    ...
    127: [function(e, t, i) {
        ...
        t.exports.registerTooltipEvent = function(e, n) {
            var o = this
              , a = function() {
                o._controlbarTooltipHandler && (clearTimeout(o._controlbarTooltipHandler),
                o._controlbarTooltipHandler = null)
            };
    ...
    129: [function(e, t, i) {
        ...
        r.extend({
            ...
            _setVolumnUI: function(e) {
                isNaN(e) || (n.css(this.volumnValue, "height", 100 * e + "%"),
                1 == e && (e = .99),
                n.css(this.volumnCursor, "bottom", 100 * e + "%"))
            }
        }));
        t.exports = s
    }
